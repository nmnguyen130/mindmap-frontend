...
export const useRagChat = ({ documentId, onError }: UseRagChatOptions) => {
    ...
    // TODO: Remove hardcoded documentId - should come from props
    const actualDocumentId = documentId || 'ebd75e05-7f31-4439-b64d-8d7b4564efb7';
    ...
    const sendMessage = useCallback(
        ...
        [actualDocumentId, isStreaming, onError]
    );
